...
#nltk.download('punkt') para quebrar as palavras evitando , ! ''
textosQuebrados = [nltk.tokenize.word_tokenize(frase) for frase in frases]

#nltk.download('stopwords') -> fazer download das stopwords

#usado para retirar do dicionário palavras que não acrescentam em nada
stopwords = nltk.corpus.stopwords.words('portuguese')

#nltk.download('rslp')
#tirando sufixo e ficando com a raiz da palavra
